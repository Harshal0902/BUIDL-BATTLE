...
interface Room2MenuProps {
    position: { x: number, y: number };
    mapOffset: { x: number, y: number };
}

export default function Room2Menu({ position, mapOffset }: Room2MenuProps) {
    return (
                                ...
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        <div className='relative'>
                                            <Image src='/escape-room/room2.png' width='756' height='756' alt='map' className='w-full mt-4 rounded' />
                                            <div
                                                className='absolute w-4 h-4 bg-red-500 rounded-full border-2 border-white'
                                                style={{
                                                    left: `calc(50% + ${(position.x - mapOffset.x) / 4}px)`,
                                                    top: `calc(50% + ${(position.y - mapOffset.y) / 4}px)`,
